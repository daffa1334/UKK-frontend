...
export default {
    ...
    created() {
        this.axios.get('http://localhost/laundry/public/api/paket', { headers : { 'Authorization' : `Bearer` + this.$store.state.token} })
            .then( (res) => {
    ...
    methods : {
        tambah() {
            this.axios.post('http://localhost/laundry/public/api/detail/tambah', 
                this.detail,
