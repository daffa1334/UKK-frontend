                                                    ...
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="col">
                                                                    ...
                                                                    <div class="h6 mb-0 font-weight-bold text-gray-800 mb-2">{{ transaksi.tgl_bayar | moment("DD/MM/YYYY") }} </div>
                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr v-if="total != ''">
                                                    <td colspon="3" class="text-right">Total</td>
...
export default {
    ...
    created() {
        this.axios.get(`http://localhost/laundry/public/api/transaksi/${this.id_transaksi}`, 
        ...
        this.axios.get(`http://localhost/laundry/public/api/detail/${this.id_transaksi}`, 
                     {headers : { 'Authorization' : `Bearer ` + this.$store.state.token}})
                .then(res =>{
                ...
                .catch(err => console.log(err))
        this.axios.get(`http://localhost/laundry/public/api/detail/total/${this.id_transaksi}`, 
                     {headers : { 'Authorization' : `Bearer ` + this.$store.state.token}})
                .then(res =>{
